...
$td_translation_map = array(
    ...
    "We_re sorry, but the page you are looking for doesn_t exist." => __("We're sorry, but the page you are looking for doesn't exist.", TD_THEME_NAME),
    ...
    'Welcome! Login in to your account' => __('Welcome! Login in to your account', TD_THEME_NAME),
    ...
    //forum
    'Search the forum' => __('Search the forum', TD_THEME_NAME),
    'Forums' => __('Forums', TD_THEME_NAME),
    ...
    'Timeline' => __('Timeline', TD_THEME_NAME),
