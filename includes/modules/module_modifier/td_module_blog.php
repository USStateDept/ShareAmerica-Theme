        ...
        if($social_sharing == 1) {
            ...
            $buffy .= '
                <div class="td-tags-and-social-wrapper-box td-tags-and-social-wrapper-box-bottom-line">
                    <a class="td-social-sharing-buttons td-social-facebook" href="https://www.facebook.com/sharer.php?u=' . urlencode(get_permalink($this->post->ID)) . '?utm_source=sa%26utm_medium=pfb%26utm_campaign=' . urlencode(date('Y-m-d')) . '" onclick="window.open(this.href, \'mywin\',
\'left=50,top=50,width=600,height=350,toolbar=0\'); return false;"><div class="td-sp td-sp-share-facebook"></div><div class="td-social-but-text">Share This</div></a>
                    <a class="td-social-sharing-buttons td-social-twitter" href="https://twitter.com/intent/tweet?text=' . $this->title . '&url=' . urlencode(get_permalink($this->post->ID)) . '?utm_source=sa%26utm_medium=ptw%26utm_campaign=' . urlencode(date('Y-m-d')) . '&via=' . get_bloginfo('name'). '" onclick="window.open(this.href, \'mywin\',
