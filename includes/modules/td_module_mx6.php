...
class td_module_mx6 extends td_module {
    ...
    function render($order_no) {
        ...
        <div class="<?php echo $this->get_module_classes(array("td-big-grid-post-$order_no", "td-big-grid-post", "td-small-thumb", "post-format-$postFormat" )); ?>"> <!-- Add class based on post format -->
            <?php
